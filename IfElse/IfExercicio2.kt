...
fun main() {
    ...
    if (numero > 0) { // Verifica se o número é maior que zero 
        println("O número é positivo.") // Se verdadeiro vai imprimir 
        ...
        println("O número é zero.") // Se nenhuma das condições anteriores forem verdadeiras imprime essa mensagem
    }
}
